  ...
  */
  ...
  if (mess_type == 0 && !pxe)
      ...
      if (!message)
	{
      ...
      METRICS_INCREMENT(METRIC_BOOTP);
  ...
  switch (mess_type)
	...
	return 0;
      ...
      METRICS_INCREMENT(METRIC_DHCPDECLINE);
	...
	message = _("unknown lease");
      ...
      METRICS_INCREMENT(METRIC_DHCPRELEASE);
      ...
      else 
	{
      ...
      METRICS_INCREMENT(METRIC_DHCPDISCOVER);
      ...
      if (option_bool(OPT_RAPID_COMMIT) && option_find(mess, sz, OPTION_RAPID_COMMIT, 0))
	{
      ...
      METRICS_INCREMENT(METRIC_DHCPOFFER);
      ...
      else
	{
      ...
      METRICS_INCREMENT(METRIC_DHCPREQUEST);
      ...
      if (!message)
	{
      ...
      if (message)
	{
	  METRICS_INCREMENT(rapid_commit ? METRIC_NOANSWER : METRIC_DHCPNAK);
      ...
      else
	{
	  ...
	  METRICS_INCREMENT(METRIC_DHCPACK);
	...
	message = _("ignored");
      ...
      METRICS_INCREMENT(METRIC_DHCPINFORM);
